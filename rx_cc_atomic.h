...
*/
    ...
    template<class T>  bool rx_atomic_cas(T* ptr, const T expected, const T desired);
        ...
        //32bit--------------------------------------------
        template<> inline void      rx_atomic_store(int32_t *ptr, const int32_t v)  { _InterlockedExchange((volatile long *)ptr,v); }
        template<> inline int32_t   rx_atomic_load(const int32_t *ptr)              { const int32_t v = *ptr; mem_barrier(); return v; }
        template<> inline int32_t   rx_atomic_swap(int32_t *ptr, const int32_t v)   { return _InterlockedExchange((volatile long *)ptr, v); }
        template<> inline int32_t   rx_atomic_add(int32_t *ptr, const int32_t v)    { return _InterlockedExchangeAdd((volatile long *)ptr, v); }
        template<> inline int32_t   rx_atomic_sub(int32_t *ptr, const int32_t v)    { return _InterlockedExchangeAdd((volatile long *)ptr,0-v); }
        template<> inline int32_t   rx_atomic_and(int32_t *ptr, const int32_t v)    { return _InterlockedAnd((volatile long *)ptr, v); }
        template<> inline int32_t   rx_atomic_or(int32_t *ptr, const int32_t v)     { return _InterlockedOr((volatile long *)ptr, v); }
        template<> inline int32_t   rx_atomic_xor(int32_t *ptr, const int32_t v)    { return _InterlockedXor((volatile long *)ptr, v); }
        ...
        template<> inline void      rx_atomic_store(int64_t *ptr, const int64_t v)  { _InterlockedExchange64((volatile long long *)ptr, v); }
        template<> inline int64_t   rx_atomic_load(const int64_t *ptr)              { const int64_t v = *ptr; mem_barrier(); return v; }
        template<> inline int64_t   rx_atomic_swap(int64_t *ptr, const int64_t v)   { return _InterlockedExchange64((volatile long long *)ptr, v); }
        template<> inline int64_t   rx_atomic_add(int64_t *ptr, const int64_t v)    { return _InterlockedExchangeAdd64((volatile long long*)ptr, v); }
        template<> inline int64_t   rx_atomic_sub(int64_t *ptr, const int64_t v)    { return _InterlockedExchangeAdd64((volatile long long*)ptr, 0-v); }
        template<> inline int64_t   rx_atomic_and(int64_t *ptr, const int64_t v)    { return _InterlockedAnd64((volatile long long*)ptr, v); }
        template<> inline int64_t   rx_atomic_or(int64_t *ptr, const int64_t v)     { return _InterlockedOr64((volatile long long*)ptr, v); }
        template<> inline int64_t   rx_atomic_xor(int64_t *ptr, const int64_t v)    { return _InterlockedXor64((volatile long long*)ptr, v); }
        ...
        template<> inline int32_t   rx_atomic_or    (int32_t *ptr, const int32_t v)   { return __sync_fetch_and_or(ptr, v); }
        ...
        template<> inline int64_t   rx_atomic_or    (int64_t *ptr, const int64_t v)   { return __sync_fetch_and_or ((volatile long long*)ptr, v); }
