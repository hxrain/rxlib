...
#define rx_new(T)               rx_global_mem_allotter().make<T>()
#define rx_new1(T,P1)           rx_global_mem_allotter().make<T>(P1)
#define rx_new2(T,P1,P2)        rx_global_mem_allotter().make<T>(P1,P2)
#define rx_new3(T,P1,P2,P3)     rx_global_mem_allotter().make<T>(P1,P2,P3)
#define rx_array(T,C)           rx_global_mem_allotter().make<T>(C)
#define rx_array1(T,P1,C)       rx_global_mem_allotter().make<T>(P1,C)
#define rx_array2(T,P1,P2,C)    rx_global_mem_allotter().make<T>(P1,P2,C)
#define rx_array3(T,P1,P2,P3,C) rx_global_mem_allotter().make<T>(P1,P2,P3,C)
#define rx_delete(P)            rx_global_mem_allotter().unmake((P))
