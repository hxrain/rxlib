...
inline void rx_hash_tlmap_base_1(rx_tdd_base &rt)
{
    ...
    uint32_t fl, sl;
    rx_hash_tlmap<tlmap_cfg_t>(0, fl, sl);
    rt.tdd_assert(fl == 5 && sl == 0);
    rx_hash_tlmap<tlmap_cfg_t>(31, fl, sl);
    rt.tdd_assert(fl == 5 && sl == 0);
    rx_hash_tlmap<tlmap_cfg_t>(32, fl, sl);
    rt.tdd_assert(fl == 5 && sl == 0);
    rx_hash_tlmap<tlmap_cfg_t>(33, fl, sl);
    rt.tdd_assert(fl == 5 && sl == 0);
    rx_hash_tlmap<tlmap_cfg_t>(36, fl, sl);
    rt.tdd_assert(fl == 5 && sl == 1);
    rx_hash_tlmap<tlmap_cfg_t>(40, fl, sl);
    rt.tdd_assert(fl == 5 && sl == 2);
    rx_hash_tlmap<tlmap_cfg_t>(47, fl, sl);
    rt.tdd_assert(fl == 5 && sl == 3);
    rx_hash_tlmap<tlmap_cfg_t>(82, fl, sl);
